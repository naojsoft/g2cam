...
class remoteObjectNameService(object):
    ...
    def clearAll(self):
        ...
        try:
            ...
            #self.register('names', self.myhost, options.port, options)
    ...
    def getInfo(self, name):
        ...
        for key in tree.keys():
            ...
            transport = tree[key].get('transport', ro.default_transport)
            encoding = tree[key].get('encoding', ro.default_encoding)
...
def main(options, args):
    ...
    try:
        try:
            ...
            nsopts = dict(secure=options.secure,
                          transport=ro.ns_transport,
                          encoding=ro.ns_encoding)
